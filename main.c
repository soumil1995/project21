...
//Input variables
int i1_d[4] = {11,10,13,11};					//Any value between 0 and 100
int i2_d[4] = {11,8,13,11};					//Any value between 0 and 100
...
for (int i = 0; i< 4;i++)
{
	...
	declaration();
	grad_derv(i1, m);
	map_func(i1, m, i1_d[i]);

	grad_derv(i2, m);
	map_func(i2, m, i2_d[i]);
